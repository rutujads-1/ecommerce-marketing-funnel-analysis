...
--estimation--
-- AOV brand
select s.utm_campaign,count(o.order_id) as total_orders_nb, sum(o.price_usd) as revenue_nb,sum(o.price_usd)/count(o.order_id) as AOV_b
from orders o
...
having s.utm_campaign='brand' or s.utm_campaign='nonbrand';
